...
from teacher.models import Professor                  # Banco de dados
from teacher.models import Aulas
from teacher.serializers import ProfessorSerializer   # Conversor para JSON
